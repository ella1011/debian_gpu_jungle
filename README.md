...
- I am not fully certain whether it would work without the current addition of "contrib" and "non-free" added to the sources.list (in "confs") but I have placed it there during one of the tries and you could try leaving this out, perhaps it works just as well (if I try it out, I will edit it here and comment)
...
- training a 12 sec 16 khz wav file on a gtx 1080 TI 11gb takes a little over a day
- training the same file on a gtx 1060 6gb takes about twice the time, approaching 2.5 days
